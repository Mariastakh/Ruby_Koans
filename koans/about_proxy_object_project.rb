...
# https://www.integralist.co.uk/posts/message-passing-in-object-oriented-code/
# http://www.railstips.org/blog/archives/2009/08/07/patterns-are-not-scary-method-missing-proxy/
# https://stackoverflow.com/questions/22192173/ruby-koans-proxy-project
...
# https://codequizzes.wordpress.com/2013/09/28/sending-messages-in-ruby/
# https://www.rubytapas.com/2012/10/17/episode-011-method-and-message/
  ...
  def number_of_times_called(which_method)
    number =  messages.select{ |x| x==which_method }
    number.length
  end
